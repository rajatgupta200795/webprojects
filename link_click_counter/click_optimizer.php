...
$query = $con->query("INSERT into $user_id (link_address , date_added , ip_address , country , continent , state , type) values ('$link_url' , '$date_added' , '$ip_address' , '$country' , '$continent' , '$state' , 'link') ");
