...
<div id="myCarousel" class="carousel slide" data-ride="carousel"  data-interval="2000">
  ...
  <div class="carousel-inner" role="listbox">
    ...
    <div class="item">
     ...
     <div class="item">
      <img  src="./img/img4.jpg" alt="Chania">
      <div class="carousel-caption">
        <h2>Class Room</h2>
        <p></p>
      </div>
...
<div style="padding-top:17px; padding-bottom:17px; background-color:#f0f0f0; font-family:Agency FB; font-size:17px; color:#412C71;">
    <div class="row">
<?php
if(isMobileDevice())
echo'  
  <div class="col-sm-12"><div class="link_change">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://www.mcskkt.com/notice_feeds.php"><b>Notice</b></a> 
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="exam_shedule.php"><b>Exam</b></a> 
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="extra_activity.php"><b>Extra Activity</b></a> 
...
<div style="margin-top: -140px; padding-top:10px; padding-bottom:50px; font-family:agency fb; background-color:#4A809E; color:white;  font-size:15px;  border-radius:10px;"><b><center style="font-size:30px;"><span  class="glyphicon glyphicon-list"></span> Notice</center></b>

<?php
$query = $con->query("SELECT * from notice where 1=1 ORDER BY added_date DESC limit 1");
...
$edit_notice = $edit_notice ." ... <a href='../notice_feeds.php' style='color:blue;'><u> read more</u></a>";
   ...
   echo"<ol class='container-fluid' style='margin-left:30px; font-family:serif;'><h4 style='font-family:agency fb;'><b><b style='color: darkblue; font-size:20px; text-decoration:underline;'>Recent Notice</b> : <u>".$row['added_day']." ".$row['added_date']."</u></b></h4>
   ".$edit_notice." </br>
   <b>Notice issued by : ".strtoupper($row['by_teacher'])."</b></ol>"; 
   }
?>

<div class="container-fluid" style="padding-left:40px; padding-right:40px; font-family:sans-serif; ">
...
"http://maps.google.com/maps?f=q&amp;source=s_q&amp;hl=en&amp;geocode=&amp;q=274303,kathkuiyan,uttarpradesh,india&amp;sspn=33.984984987,77.607422&amp;ie=UTF8&amp;hq=&amp;hnear=274303,kathkuiyan,uttarpradesh,india&amp;z=12&amp;output=embed"></iframe> 
</div>
</div>
