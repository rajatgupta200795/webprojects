...
echo'
<div style="width:30%; height:70px; background-color:white; padding:16px; font-size: 26px; font-family: \'Open Sans Condensed\', sans-serif; border-top-left-radius:10px;"> What is new for sale ?</div>
