...
$query=$con->query("UPDATE users set name = '$name', mobile='$mobile', street='$street', city='$city', state='$state' where username='$username'");
if($query)
header("location:profile.php?profile_update=successful");
