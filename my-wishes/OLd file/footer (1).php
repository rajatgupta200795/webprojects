...
<div style="bottom: 0px; padding-right:0px; position: relative; width: 100%; text-align: center; height: <?php if(!isMobileDevice()) echo'30%'; else echo'55%'; ?>; border-top: 1px solid #f3f3ee; background-color: #6c6767;">
    <div class="row">
        <div class="col-sm-3">
