...
<html>
<head>
    <title>My Bhaiya Dooj Wishes For You.</title>
    <meta charset="utf-8">
    <meta name="description" content="Send online Bhai Dooj wishes to your  Brothers, friends, relative by sending them your ewishes.">
...
<p style="font-family: 'Raleway', sans-serif; font-size: 50px;" id="festColorId">Happy Bhai Dooj <script type="text/javascript">document.write((receiver.substring(0,1).toUpperCase()+receiver.substring(1)).split("%20")[0])</script>
...
<img width="370" height="210" style="border:2px solid grey;" src="bhai-dooj.png">
