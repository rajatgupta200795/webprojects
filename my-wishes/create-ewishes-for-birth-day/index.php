...
<script>
  ...
  gtag('config', 'UA-108473282-1');
    ...
    <title>Send online Birthday wishes</title>
        <meta name="description" content="Send online Birthday e-wishes to your friends, girlfriend, relative.">
...
<p style="font-size: 30px;">Create Your Digital Wishes For Birthday.</p>
</br></br>
<p id="newUserDetails" class="hidden" style=" z-index: 2; ">
    ...
    <buttton type="submit" onclick="genLink()" class="btn btn-info btn-lg"><b>Generate Birthday Wishes</b></buttton>
    </form>
    </br>
...
<!--
<p style="font-size: 30px;">Send Birthday Wishes With Lovely Video.</p>
...
<div style="font-size: 17px;">Just copy this link and send it to your friends, relatives to wish them <b>HAPPY Birthday .</b></div>
-->
...
<script type="text/javascript">
		...
		document.getElementById('showLink').innerHTML = '<a href="my-online-birth-day-ewishes.php?{{senderName}}-sent-a-wish-to-{{receiverName}}"style="font-size:15px;">http://www.ewishes.online/create-ewishes-for-birth-day/my-online-birth-day-ewishes.php?{{senderName}}-sent-a-wish-to-{{receiverName}}</a>';	
</script>
