...
<html>
<head>
    <title>See my Happy Choti Diwali (Narak Chaudas) messgage and video for you.</title>
    <meta charset="utf-8">
...
<p style="font-family: 'Raleway', sans-serif; font-size: 50px;" id="festColorId">Happy Narak Chaudas <script type="text/javascript">document.write((receiver.substring(0,1).toUpperCase()+receiver.substring(1)).split("%20")[0])</script>
...
<iframe width="370" height="210" src="https://www.youtube.com/embed/s5W_QiuFjgo" frameborder="4" allowfullscreen></iframe>
</br></br> 
Copy and share this link : <b style="font-size: 25px;"><a href="https://youtu.be/s5W_QiuFjgo">https://youtu.be/s5W_QiuFjgo</a></b></br>
<div style="font-size: 17px;">Just copy this link and send it to your friends, relatives to wish them <b>A HAPPY Narak Chaudas.</b></div> 
</p> 
...
<a href="index.php"  class="btn btn-danger btn-lg"  style="z-index: 2; position: absolute; margin-left: -80px;" onclick="newUser();">Create My Wish</a>
