...
<p id="newUserDetails" class="hidden" style=" z-index: 2; ">
    ...
    <?php
    if(!isMobileDevice())
    echo'<buttton type="submit" onclick="genLink()" class="btn btn-success btn-lg"><b>Create Diwali Wishes</b></buttton>';
    else{
        echo'<a href="https://api.whatsapp.com/send?text=touch this blue line and see magic
         👉 http://www.devopsrider.com/create-ewishes-for-diwali/my-online-diwali-ewishes.php?{{senderName}}-sent-a-wish-to-" class="btn btn-success btn-lg" style="font-family:arial;">Share on Whatsapp</a>';
        }
        ?>
...
<p class="hidden" id="linkCopied"style="font-size:20px;"><button class="btn btn-success btn-lg">Wishes Copied</button></br></br> Your diwali wishes has been copied, now please share it.</p>

</br>

<script type="text/javascript">

        document.getElementById('showLink').innerHTML = '<a id="textLink" style="background-color:white; padding:5px;" href="my-online-diwali-ewishes.php?{{senderName}}-sent-a-wish-to-" style="font-size:15px;">http://www.devopsrider.com/create-ewishes-for-diwali/my-online-diwali-ewishes.php?{{senderName}}-sent-a-wish-to-</a></br></br></br> <button class="btn btn-primary btn-lg" onClick="copyToClipboard()">Copy</button>'; 
