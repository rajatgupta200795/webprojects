...
<html>
<head>
    <title>See my Happy Diwali message and video for you.</title>
    <meta charset="utf-8">
...
<body style="background-color: zz; overflow-x: hidden;"  ng-app="" >
...
<p style="font-family: 'Raleway', sans-serif; font-size: 50px;" id="festColorId">Happy Diwali <script type="text/javascript">document.write((receiver.substring(0,1).toUpperCase()+receiver.substring(1)).split("%20")[0])</script>

</br>


<div style=" font-family: 'Poppins', sans-serif; font-size: 20px;">
दीयों की रोशनी से जगमगाता आँगन हो 
पटाको की गूँज से आसमान रोशन हो 
