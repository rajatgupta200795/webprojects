...
<script>
  ...
  gtag('config', 'UA-108473282-1');
    ...
    <title>Send online Dussehra wishes.</title>
        <meta name="description" content="Send Dussehra wishes to your friends, girlfriend, relative online.">
...
<p style="font-size: 30px;">Create Your Dussehra Wishes.</p>
</br></br>
<p id="newUserDetails" class="hidden" style=" z-index: 2; ">
    ...
    <buttton type="submit" onclick="genLink()" class="btn btn-info btn-lg"><b>Generate Dussehra Wishes</b></buttton>
    </form>
    </br>
...
<p style="font-size: 30px;">Send Dussehra Wishes With Lovely Video.</p>
...
<div style="font-size: 17px;">Just copy this link and send it to your friends, relatives to wish them <b>A HAPPY Dussehra .</b></div>
...
<script type="text/javascript">
		...
		document.getElementById('showLink').innerHTML = '<a href="my-online-dussehra-ewishes.php?{{senderName}}-sent-a-wish-to-{{receiverName}}"style="font-size:15px;"> http://www.ewishes.online/create-ewishes-for-dussehra/my-online-dussehra-ewishes.php?{{senderName}}-sent-a-wish-to-{{receiverName}}</a>';	
</script>
...
<?php include "what-is-dussehra.php"; ?>
