...
<script>
  ...
  gtag('config', 'UA-108473282-1');
    ...
    <title>Send Guru Poornima Wishes (Dev Diwali).</title>
        <meta name="description" content="Send online Guru Poornima and Dev Diwali e-wishes to your friends, girlfriend, relative.">
...
<p style="font-size: 30px;">Create Wishes For Guru Purnima (Dev Diwali) </p>
</br></br>
<p id="newUserDetails" class="hidden" style=" z-index: 2; ">
    ...
    <buttton type="submit" onclick="genLink()" class="btn btn-info btn-lg"><b>Generate Guru Purnima Wishes</b></buttton>
    </form>
    </br>
...
<p style="font-size: 30px;">Send Guru Purnima Wishes With Lovely Video.</p>
...
<div style="font-size: 17px;">Just copy this link and send it to your friends, relatives to wish them <b>A HAPPY Guru Purnima .</b></div>
...
<script type="text/javascript">
		...
		document.getElementById('showLink').innerHTML = '<a href="my-online-guru-poornima-ewishes.php?{{senderName}}-sent-a-wish-to-{{receiverName}}"style="font-size:15px;">http://www.ewishes.online/create-ewishes-for-guru-purnima/my-online-guru-poornima-ewishes.php?{{senderName}}-sent-a-wish-to-{{receiverName}}</a>';	
</script>
...
<?php include "what-is-guru-poornima.php";?>
