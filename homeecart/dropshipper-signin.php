...
<div style="font-size: 30px;"> Sign In As A Dropshipper</div>
...
<form class="navbar-form" action="dropshipper-signin.php" method="POST">
<div class="form-group-lg">
</br></br>
<span class="glyphicon glyphicon-user" style="font-size: 70px; color: grey;"></span></br></br>
<input type="text" class="form-control" size="23" value="<?php echo$email; ?>" name="email_signin" placeholder="Email or username" required></br></br>
<input type="password" class="form-control" size="23" name="pswd" placeholder="Password" required></br></br>
...
<a href="new-dropshipper-register.php" class="btn btn-success" style="width: 85%; padding: 12px;">Register As New</a></br></br>
</div>
</form>
...
$query=$con->query("SELECT * FROM member WHERE  email='$email' and password='$pswd'");
  ...
  header("location:dropshipper-home.php?login_successfully");
}else{
