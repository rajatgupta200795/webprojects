...
$query1 = $con->query("UPDATE member set account_status='1', transaction_id='$transaction_id' where username='$username'");
if($query && $query1) {
...
<h3><center>New Membership Requests</center></h3>
<hr>
</br>
...
if($account_status=='0') $account_status = '<span style="color:red;">Pending</span>';
...
<a href="?membership-verify-confirm=true&username='.$username.'&transaction_id='.$transaction_id.'" class="btn btn-success btn-lg">Verify</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="open-new-membership-request.php" class="btn btn-danger btn-lg">Cancel</a>
